...
export function DepartamentoCreatingDialog({ children }: Props) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    post(route('catalogs.departamentos.store'), {
      preserveScroll: true,
      onSuccess: () => {
    ...
    <AlertDialog open={open} onOpenChange={setOpen}>
      ...
      <AlertDialogContent>
        <form onSubmit={handleSubmit} className="grid gap-4" autoComplete="off">
          <AlertDialogHeader>
            <AlertDialogTitle>Crear Departamento</AlertDialogTitle>
            <AlertDialogDescription>Ingresa el nombre del departamento.</AlertDialogDescription>
          </AlertDialogHeader>
          <section>
            <div>
