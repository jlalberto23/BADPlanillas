...
export function SeccionCreatingDialog({ children }: Props) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    post(route('catalogs.secciones.store'), {
      preserveScroll: true,
      onSuccess: () => {
    ...
    <AlertDialog open={open} onOpenChange={setOpen}>
      ...
      <AlertDialogContent>
        <form onSubmit={handleSubmit} className="grid gap-4" autoComplete="off">
          <AlertDialogHeader>
            <AlertDialogTitle>Crear Seccion</AlertDialogTitle>
            <AlertDialogDescription>Ingresa el nombre de la seccion.</AlertDialogDescription>
          </AlertDialogHeader>
          <section>
            <div>
