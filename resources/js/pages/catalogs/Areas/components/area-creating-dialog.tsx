...
export function AreaCreatingDialog({ children }: Props) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    post(route('catalogs.areas.store'), {
      preserveScroll: true,
      onSuccess: () => {
    ...
    <AlertDialog open={open} onOpenChange={setOpen}>
      ...
      <AlertDialogContent>
        <form onSubmit={handleSubmit} className="grid gap-4" autoComplete="off">
          <AlertDialogHeader>
            <AlertDialogTitle>Crear Area</AlertDialogTitle>
            <AlertDialogDescription>Ingresa el nombre del area.</AlertDialogDescription>
          </AlertDialogHeader>
          <section>
            <div>
